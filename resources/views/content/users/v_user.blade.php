                ...
                <div class="modal-content">
                    ...
                    <form id="formSubmit">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Jurusan</label>
                                <select name="id_major" class="form-control" id="id_major">
                            ...
                            <div class="form-group m-form__group row">
                                <div class="col-lg-6 m-form__group-sub">
                                    ...
                                    <input type="text" class="form-control m-input datepickerYear" readonly
                                        name="graduating_class" id="graduating_class" value="{{ date('Y') }}">
                                </div>
                                <div class="col-lg-6 m-form__group-sub">
                                    <label class="form-control-label">Tahun Lulus</label>
                                    <input type="text" class="form-control m-input datepickerYear" name="graduation_year"
                                        id="graduation_year" readonly value="{{ date('Y') }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-8">
            ...
            function editData(id) {
                $.ajax({
                    ...
                    success: (data) => {
                        ...
                        $('#graduating_class').val(data.graduating_class);
                        $('#graduation_year').val(data.graduation_year);
                        $('#id_major').val(data.id_major).trigger('change');
